...
DB_PATH         = os.path.expanduser("~/.acurist.db")
MCP_CONFIG_PATH = os.path.expanduser("~/.acurist_mcp.json")
MAX_HISTORY     = 10
MAX_RETRIES     = 3
...
BANNER = (
    f"{COLORS['bold']}{COLORS['cyan']}                            _____       _____ {COLORS['reset']}\n"
    f"{COLORS['cyan']}______ __________  ___________(_{COLORS['reset']}{COLORS['blue']})________  /_{COLORS['reset']}\n"
    f"{COLORS['blue']}_  __ `/  ___/  / / /_  ___/_{COLORS['reset']}{COLORS['bold']}{COLORS['blue']}  /__  ___/  __/{COLORS['reset']}\n"
    f"{COLORS['bold']}{COLORS['blue']}/ /_/ // /__ / /_/ /_  /   _{COLORS['reset']}{COLORS['bold']}{COLORS['magenta']}  / _(__  )/ /_  {COLORS['reset']}\n"
    f"{COLORS['bold']}{COLORS['magenta']}\\__,_/ \\___/ \\__,_/ /_/    /_/{COLORS['reset']}{COLORS['magenta']}  /____/ \\__/{COLORS['reset']}\n"
    f"\n"
...
Output ONLY JSON lines. No explanation, no markdown.
    ...
    def process(self, user_input: str):
        ...
        dyn_engine.engine._mcp_client       = self._mcp_client   # for mcp_call steps
